cat << 'INNER_EOF' > snippet_buttons.txt
...
sed -i -e '/<p className="text-xs text-center text-\[#A69D92\] font-semibold mb-1 uppercase tracking-wider">How would you like to proceed?<\/p>/,/<svg xmlns="http:\/\/www.w3.org\/2000\/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor">/!b' \
     -e '/<svg xmlns="http:\/\/www.w3.org\/2000\/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor">/!d; /<svg xmlns="http:\/\/www.w3.org\/2000\/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor">/r snippet_buttons.txt' \
     -e 'd' app/contact/page.tsx
